...
if __name__ == '__main__':
	...
	entity_vec = read_vec("result1/"+entity_file,entity_vec)
	relation_vec = read_vec("result1/"+relation_file,relation_vec)
	print("dddd",len(entity_vec))
	samples_train,target_train = load_train("train_link.txt",entity_vec,relation_vec)
	samples_test,target_test = load_train("test_link.txt",entity_vec,relation_vec)
	#print(type(samples))
	#print(type(target))
